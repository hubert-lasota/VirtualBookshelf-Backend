...
ALTER TABLE reading_book
    ALTER COLUMN total_notes SET DEFAULT 0,
...
(9, 'Mocny początek', 'Świetne otwarcie, od razu buduje napięcie.', 1, 50, now(), NULL),
(9, 'Pierwszy zwrot akcji', 'Nieoczekiwany moment zmienia całą historię.', 120, 150, now(), NULL),
(9, 'Rozwinięcie postaci', 'Bardzo ciekawe tło psychologiczne bohatera.', 200, 250, now(), NULL),
(9, 'Klimatyczny opis', 'Opis małego miasteczka bardzo sugestywny.', 400, 420, now(), NULL),
(9, 'Finał', 'Zakończenie trzymające w napięciu do końca.', 780, 823, now(), NULL),

-- reading_book_id 10 (book_id 311)
(10, 'Wciągający początek', 'Od razu widać mistrzowski styl Kinga.', 1, 30, now(), NULL),
(10, 'Budowanie atmosfery', 'Mrok i napięcie w opisach przyrody.', 100, 150, now(), NULL),
(10, 'Charakter antagonisty', 'Postać złoczyńcy wyjątkowo przerażająca.', 200, 250, now(), NULL),
(10, 'Kulminacja', 'Akcja nabiera ogromnego tempa.', 500, 600, now(), NULL),
(10, 'Zakończenie', 'Świetny epilog, pozostawia niedosyt.', 620, 640, now(), NULL),

-- reading_book_id 11 (book_id 312)
(11, 'Otwarcie', 'Intrygujący początek historii.', 1, 20, now(), NULL),
(11, 'Relacje bohaterów', 'Świetnie oddane napięcia między postaciami.', 150, 180, now(), NULL),
(11, 'Pierwszy dramat', 'Moment, który naprawdę wstrząsa czytelnikiem.', 250, 280, now(), NULL),
(11, 'Opis miejsc', 'King genialnie buduje mroczny klimat.', 350, 370, now(), NULL),
(11, 'Finałowe sceny', 'Trzyma w napięciu aż do ostatniej strony.', 480, 515, now(), NULL),

-- reading_book_id 12 (book_id 313)
(12, 'Wstęp', 'Prolog wciąga od pierwszej strony.', 1, 40, now(), NULL),
(12, 'Rozwinięcie', 'Bardzo interesująca narracja i budowa świata.', 200, 230, now(), NULL),
(12, 'Wątek poboczny', 'Dobrze uzupełnia główną historię.', 350, 380, now(), NULL),
(12, 'Kulminacja', 'Prawdziwy rollercoaster emocji.', 700, 750, now(), NULL),
(12, 'Zakończenie', 'Mocne i satysfakcjonujące.', 770, 790, now(), NULL),

-- reading_book_id 13 (book_id 314)
(13, 'Start', 'Dynamiczne rozpoczęcie historii.', 1, 20, now(), NULL),
(13, 'Postać główna', 'Coraz ciekawsze rysy psychologiczne.', 100, 130, now(), NULL),
(13, 'Zwrot akcji', 'Historia zmienia się o 180 stopni.', 150, 180, now(), NULL),
(13, 'Nowy wątek', 'Wprowadza ciekawą dynamikę.', 200, 230, now(), NULL),
(13, 'Fragment pełen grozy', 'Jeden z najlepszych momentów.', 220, 230, now(), NULL),

-- reading_book_id 14 (book_id 315)
(14, 'Otwarcie', 'Lekkość stylu, ale czuć narastający mrok.', 1, 15, now(), NULL),
(14, 'Pierwsze napięcia', 'Pojawiają się konflikty między bohaterami.', 80, 100, now(), NULL),
(14, 'Wstrząs', 'Szokujący moment zmienia kierunek opowieści.', 110, 120, now(), NULL),
(14, 'Nowa relacja', 'Bardzo ciekawa dynamika między postaciami.', 60, 90, now(), NULL),
(14, 'Scena w półmroku', 'Dreszcz przechodzi podczas czytania.', 110, 120, now(), NULL),

-- reading_book_id 15 (book_id 316)
(15, 'Początek', 'Wprowadzenie do historii z klimatem grozy.', 1, 30, now(), NULL),
(15, 'Pierwsza tragedia', 'Szokująca scena budująca atmosferę.', 100, 140, now(), NULL),
(15, 'Rozwój bohatera', 'Ciekawa przemiana postaci głównej.', 200, 250, now(), NULL),
(15, 'Napięcie', 'Akcja staje się coraz bardziej intensywna.', 300, 330, now(), NULL),
(15, 'Cliffhanger', 'Pozostawia czytelnika z pytaniami.', 320, 340, now(), NULL),

-- reading_book_id 16 (book_id 317)
(16, 'Wprowadzenie', 'Pierwsze strony dobrze nastrajają.', 1, 20, now(), NULL),
(16, 'Zarys świata', 'Świetnie opisane realia.', 50, 70, now(), NULL),
(16, 'Pierwsze konflikty', 'Postacie zaczynają się ścierać.', 80, 90, now(), NULL),
(16, 'Nowy motyw', 'Dodaje świeżości do historii.', 60, 80, now(), NULL),
...
VALUES
-- reading_book_id 9 (book_id 310)
(9, 1, 200, '2023-01-05 18:00', '2023-01-05 20:00', 'Pierwsze podejście.', now(), NULL),
(9, 201, 400, '2023-01-10 19:00', '2023-01-10 21:30', 'Dłuższa lektura.', now(), NULL),
(9, 401, 600, '2023-01-20 20:00', '2023-01-20 22:00', 'Wieczór z książką.', now(), NULL),
(9, 601, 823, '2023-02-15 18:00', '2023-02-15 21:00', 'Finałowa sesja.', now(), NULL),

-- reading_book_id 10 (book_id 311)
(10, 1, 200, '2023-03-01 17:00', '2023-03-01 19:00', 'Mocne rozpoczęcie.', now(), NULL),
(10, 201, 400, '2023-03-10 19:00', '2023-03-10 21:30', 'Środek historii.', now(), NULL),
(10, 401, 640, '2023-03-28 20:00', '2023-03-28 23:00', 'Zakończenie.', now(), NULL),

-- reading_book_id 11 (book_id 312)
(11, 1, 150, '2023-04-10 18:00', '2023-04-10 20:00', 'Start książki.', now(), NULL),
(11, 151, 350, '2023-04-18 19:00', '2023-04-18 21:00', 'Rozwój akcji.', now(), NULL),
(11, 351, 515, '2023-05-02 18:00', '2023-05-02 21:00', 'Zakończenie.', now(), NULL),

-- reading_book_id 12 (book_id 313)
(12, 1, 200, '2023-06-01 17:00', '2023-06-01 19:00', 'Pierwsze wrażenia.', now(), NULL),
(12, 201, 400, '2023-06-15 20:00', '2023-06-15 22:30', 'Środek historii.', now(), NULL),
(12, 401, 600, '2023-06-25 19:00', '2023-06-25 21:30', 'Akcja nabiera tempa.', now(), NULL),
(12, 601, 790, '2023-07-05 18:00', '2023-07-05 22:00', 'Wielki finał.', now(), NULL),

-- reading_book_id 13 (book_id 314)
(13, 1, 80, '2024-01-10 18:00', '2024-01-10 19:30', 'Rozpoczęcie czytania.', now(), NULL),
(13, 81, 160, '2024-01-15 19:00', '2024-01-15 20:30', 'Kolejna sesja.', now(), NULL),
(13, 161, 230, '2024-01-20 20:00', '2024-01-20 22:00', 'Zatrzymanie się w połowie.', now(), NULL),

-- reading_book_id 14 (book_id 315)
(14, 1, 60, '2024-02-01 18:00', '2024-02-01 19:00', 'Pierwsze strony.', now(), NULL),
(14, 61, 120, '2024-02-10 19:00', '2024-02-10 20:30', 'Dalsza lektura.', now(), NULL),

-- reading_book_id 15 (book_id 316)
(15, 1, 120, '2024-03-05 18:00', '2024-03-05 20:00', 'Rozpoczęcie książki.', now(), NULL),
(15, 121, 220, '2024-03-12 19:00', '2024-03-12 21:00', 'Środek akcji.', now(), NULL),
(15, 221, 300, '2024-03-18 20:00', '2024-03-18 21:30', 'Kolejne wydarzenia.', now(), NULL),
(15, 301, 340, '2024-03-25 18:00', '2024-03-25 19:30', 'Ostatnie strony na razie.', now(), NULL),

-- reading_book_id 16 (book_id 317)
(16, 1, 40, '2024-03-20 18:00', '2024-03-20 19:00', 'Wstęp.', now(), NULL),
(16, 41, 70, '2024-03-22 19:00', '2024-03-22 20:00', 'Dalsze strony.', now(), NULL),
(16, 71, 90, '2024-03-25 20:00', '2024-03-25 21:00', 'Zatrzymanie się na krótkim fragmencie.', now(), NULL);


-- READING BOOK START-ID=23
INSERT INTO reading_book(bookshelf_id, book_id, status, current_page, total_notes, total_sessions, started_reading_at,
...
(2, 1, 'READING', 240, 5, 2, '2024-09-06 09:45:00', NULL, now()),
...
(23, 'Notatka 5', 'Podsumowanie.', 433, 540, now()),
...
(24, 'Notatka 5', 'Zakończenie wątku.', 399, 498, now()),
...
(25, 'Notatka 5', 'Refleksje po zakończeniu.', 457, 570, now()),
...
(26, 'Notatka 5', 'Podsumowanie wątków.', 433, 540, now()),
...
(27, 'Notatka 5', 'Punkty zwrotne.', 201, 250, now()),
...
(28, 'Notatka 5', 'Podsumowanie wątku.', 201, 250, now()),
...
(29, 'Notatka 5', 'Podsumowanie.', 191, 237, now()),
...
(30, 'Notatka 5', 'Podsumowanie.', 231, 288, now()),
...
(31, 'Notatka 5', 'Wnioski.', 201, 250, now()),
...
(32, 'Notatka 5', 'Podsumowanie wątku.', 253, 315, now()),
...
(33, 'Notatka 5', 'Wnioski.', 201, 250, now()),
...
VALUES
-- READ sessions
(23, 1, 82, '2024-01-01 08:00:00', '2024-01-02 10:00:00', 'Pierwsza sesja', now()),
(23, 83, 164, '2024-01-02 11:00:00', '2024-01-03 12:00:00', 'Druga sesja', now()),
(23, 165, 246, '2024-01-03 13:00:00', '2024-01-04 14:00:00', 'Trzecia sesja', now()),

(24, 1, 77, '2024-01-02 09:00:00', '2024-01-03 11:00:00', 'Pierwsza sesja', now()),
(24, 78, 154, '2024-01-03 12:00:00', '2024-01-04 13:00:00', 'Druga sesja', now()),
(24, 155, 231, '2024-01-04 14:00:00', '2024-01-05 15:00:00', 'Trzecia sesja', now()),
...
-- READING BOOK END-ID=44
-- reading_note
INSERT INTO reading_note(reading_book_id, title, content, page_from, page_to, created_at)
VALUES
-- Hobbit
(41, 'Początek przygody', 'Bilbo wyrusza w nieznane, spotkania z elfami i krasnoludami.', 1, 62, now()),
(41, 'Pierwsze wyzwania', 'Spotkanie z trollami i pierwsze lekcje odwagi.', 63, 124, now()),
(41, 'Niebezpieczeństwa w drodze', 'Zagrożenia i przyjaźnie na trasie podróży.', 125, 186, now()),
(41, 'Smocze tajemnice', 'Pierwsze zetknięcie z zagadkami Smauga.', 187, 248, now()),
(41, 'Podsumowanie przygody', 'Bilbo powraca do domu z nowym doświadczeniem.', 249, 310, now()),

-- Władca Pierścieni 1
(42, 'Nowy wątek', 'Frodo otrzymuje pierścień i rozpoczyna swoją misję.', 1, 112, now()),
(42, 'Spotkania i niebezpieczeństwa', 'Podróż przez Śródziemie, nowe postacie i zagrożenia.', 113, 224, now()),
(42, 'Próby i zdrady', 'Frodo i Drużyna stają przed poważnymi próbami.', 225, 336, now()),
(42, 'Bitwy i decyzje', 'Decydujące starcia z wrogami, konflikty wewnętrzne bohaterów.', 337, 448, now()),
(42, 'Podsumowanie części', 'Zakończenie pierwszej części podróży.', 449, 450, now()),

-- Władca Pierścieni 2
(43, 'Początek wędrówki', 'Frodo i Sam kontynuują podróż przez trudne tereny.', 1, 112, now()),
(43, 'Niebezpieczeństwa', 'Przeszkody na trasie, starcia z wrogami.', 113, 224, now()),
(43, 'Spotkania', 'Nowe postacie i wyzwania moralne.', 225, 336, now()),
(43, 'Decyzje i konflikty', 'Trudne wybory bohaterów.', 337, 448, now()),
(43, 'Refleksje i wnioski', 'Podsumowanie wydarzeń i przygotowanie do finału.', 449, 450, now()),

-- Władca Pierścieni 3
(44, 'Wędrówka', 'Bohaterowie zmierzają w stronę ostatecznej konfrontacji.', 1, 112, now()),
(44, 'Niebezpieczeństwa', 'Wrogowie czyhają na każdym kroku.', 113, 224, now()),
(44, 'Starcia', 'Bitwy i dramatyczne wydarzenia.', 225, 336, now()),
(44, 'Finał', 'Ostateczne starcie dobra ze złem.', 337, 448, now()),
...
VALUES
-- Hobbit
(41, 1, 62, '2024-02-01 08:00:00', '2024-02-01 10:00:00', 'Pierwsza sesja', now()),
(41, 63, 124, '2024-02-01 11:00:00', '2024-02-01 13:00:00', 'Druga sesja', now()),
(41, 125, 186, '2024-02-02 08:00:00', '2024-02-02 10:00:00', 'Trzecia sesja', now()),

-- Władca Pierścieni 1
(42, 1, 112, '2024-02-02 08:00:00', '2024-02-02 10:00:00', 'Pierwsza sesja', now()),
(42, 113, 224, '2024-02-03 08:00:00', '2024-02-03 10:00:00', 'Druga sesja', now()),
(42, 225, 336, '2024-02-04 08:00:00', '2024-02-04 10:00:00', 'Trzecia sesja', now()),

-- Władca Pierścieni 2
(43, 1, 112, '2024-02-05 08:00:00', '2024-02-05 10:00:00', 'Pierwsza sesja', now()),
(43, 113, 224, '2024-02-06 08:00:00', '2024-02-06 10:00:00', 'Druga sesja', now()),
(43, 225, 336, '2024-02-07 08:00:00', '2024-02-07 10:00:00', 'Trzecia sesja', now()),

-- Władca Pierścieni 3
(44, 1, 112, '2024-02-08 08:00:00', '2024-02-08 10:00:00', 'Pierwsza sesja', now()),
(44, 113, 224, '2024-02-09 08:00:00', '2024-02-09 10:00:00', 'Druga sesja', now()),
(44, 225, 336, '2024-02-10 08:00:00', '2024-02-10 10:00:00', 'Trzecia sesja', now());


-- READING BOOK START-ID=45
INSERT INTO reading_book(bookshelf_id, book_id, status, current_page, total_notes, total_sessions, started_reading_at,
                         finished_reading_at, created_at)
VALUES
-- READ
...
(2, 2, 'READING', 180, 5, 2, '2024-09-02 09:00:00', NULL, now()),
(3, 356, 'READING', 150, 5, 2, '2024-09-03 09:00:00', NULL, now());

-- READING BOOK END-ID=49

-- reading_note
INSERT INTO reading_note(reading_book_id, title, content, page_from, page_to, created_at)
VALUES
-- Book 353
(45, 'Wprowadzenie do Agile', 'Podstawy zwinnego wytwarzania oprogramowania, wartości i zasady.', 1, 90, now()),
(45, 'Zasady SOLID', 'Omówienie zasad SOLID i ich znaczenie w czystym kodzie.', 91, 180, now()),
(45, 'Refaktoryzacja', 'Jak poprawiać kod bez zmiany jego zachowania.', 181, 270, now()),
(45, 'Test Driven Development', 'Praktyki pisania testów najpierw.', 271, 360, now()),
(45, 'Wzorce projektowe', 'Najważniejsze wzorce projektowe w praktyce.', 361, 450, now()),

-- Book 354
(46, 'Wprowadzenie do czystego kodu', 'Jak pisać kod czytelny i łatwy w utrzymaniu.', 1, 50, now()),
(46, 'Refaktoryzacja metod', 'Praktyczne wskazówki refaktoryzacji.', 51, 100, now()),
(46, 'Zasady projektowania klas', 'Tworzenie dobrze zaprojektowanych klas.', 101, 150, now()),
(46, 'Testy jednostkowe', 'Pisanie skutecznych testów jednostkowych.', 151, 200, now()),
(46, 'Dobre praktyki', 'Ogólne wskazówki i pułapki do unikania.', 201, 200, now()),

-- Book 355
(47, 'Podstawy czystego architektonicznie kodu', 'Znaczenie modularności i separacji odpowiedzialności.', 1, 45, now()),
(47, 'Zarządzanie zależnościami', 'Inwersja kontroli i wstrzykiwanie zależności.', 46, 90, now()),
(47, 'Testowanie integracyjne', 'Jak testować większe moduły.', 91, 135, now()),
(47, 'Projektowanie systemów', 'Podstawowe wzorce architektoniczne.', 136, 180, now()),
(47, 'Refaktoryzacja systemowa', 'Utrzymywanie dużych systemów w czystości.', 181, 180, now()),

-- Book 356
(48, 'Zwinne wytwarzanie oprogramowania', 'Agile w praktyce – wartości, ceremonie, retrospektywy.', 1, 50, now()),
(48, 'Zwinne zespoły', 'Organizacja zespołów programistycznych.', 51, 100, now()),
(48, 'Praktyki XP', 'Extreme Programming i praktyczne wskazówki.', 101, 150, now()),
(48, 'Planowanie sprintów', 'Efektywne planowanie i estymacja.', 151, 200, now()),
...
VALUES
-- Book 353
(45, 1, 150, '2024-03-01 08:00:00', '2024-03-01 10:00:00', 'Pierwsza sesja', now()),
(45, 151, 300, '2024-03-02 08:00:00', '2024-03-02 10:00:00', 'Druga sesja', now()),
(45, 301, 450, '2024-03-03 08:00:00', '2024-03-03 10:00:00', 'Trzecia sesja', now()),

-- Book 354
(46, 1, 70, '2024-09-01 08:00:00', '2024-09-01 09:00:00', 'Pierwsza sesja', now()),
(46, 71, 140, '2024-09-01 09:30:00', '2024-09-01 10:30:00', 'Druga sesja', now()),
(46, 141, 200, '2024-09-02 08:00:00', '2024-09-02 09:00:00', 'Trzecia sesja', now()),

-- Book 355
(47, 1, 60, '2024-09-02 09:00:00', '2024-09-02 10:00:00', 'Pierwsza sesja', now()),
(47, 61, 120, '2024-09-03 08:00:00', '2024-09-03 09:00:00', 'Druga sesja', now()),
(47, 121, 180, '2024-09-03 09:30:00', '2024-09-03 10:30:00', 'Trzecia sesja', now()),

-- Book 356
(48, 1, 50, '2024-09-04 08:00:00', '2024-09-04 09:00:00', 'Pierwsza sesja', now()),
(48, 51, 100, '2024-09-04 09:30:00', '2024-09-04 10:30:00', 'Druga sesja', now()),
